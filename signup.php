...
if($_SERVER["REQUEST_METHOD"] == 'POST'){
    ...
    if (($password == $cpassword)){
        ...
        $sql = "INSERT INTO `users` (`username`, `password`, `dtime`) VALUES ('$username', '$hash', current_timestamp())";
  ...
  <body>
    ...
    if($showAlert){
          echo  '<div class="alert alert-success alert-dismissible fade show" role="alert">
                <strong>Success!</strong> You account is created successfully so now, you can login to our website.
